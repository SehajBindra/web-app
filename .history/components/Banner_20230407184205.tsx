          ...
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <div className="hidden ml-auto lg:flex lg:items-center lg:justify-center lg:space-x-10">
              ...
              <a
                href="#"
                title=""
                className="text-base font-semibold text-white/80 transition-all duration-200 hover:text-opacity-80"
              >
                {" "}
                Products{" "}
              </a>
              ...
              <a
                href="#"
                title=""
                className="inline-flex items-center justify-center px-5 py-2.5 text-base font-semibold transition-all duration-200 rounded-full bg-blue-300 text-white hover:bg-blue-400 "
                role="button"
              >
                {" "}
                Shop Now{" "}
          ...
          <div className="relative flex items-center justify-center w-full lg:order-2 lg:w-7/12">
            ...
            <div className="relative px-4 pt-24 pb-16 text-center sm:px-6 md:px-24 2xl:px-32 lg:py-24 lg:text-left">
              ...
              <p className="mt-8 text-[16px] text-white/80">
                We believe that rice is not just a staple food item, but an art
                form that has been perfected over generations. Our commitment to
                the art of rice can be seen in every grain that we offer,
                crafted with quality and care to ensure that every meal is an
                experience to savor.
              </p>
