...
function AboutUs() {
  return (
    <div>
      <div className="2xl:container bg-black 2xl:mx-auto lg:py-8 lg:px-20 md:py-8 pb-40 md:px-6 py-4 px-4">
        <div className="flex flex-col lg:flex-row justify-between gap-8">
          <div className="w-full lg:w-5/12 flex flex-col justify-center">
            <h1 className="text-3xl text-center my-4 lg:text-5xl font-bold leading-9 text-white pb-4">
              About Us
            </h1>
            <p className="font-normal text-justify -tracking-tighter text-base leading-6 text-white/80">
