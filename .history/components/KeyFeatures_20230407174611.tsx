        ...
        <div className="relative mt-12 lg:mt-20">
          ...
          <div className="relative grid grid-cols-1 text-center gap-y-12 md:grid-cols-3 gap-x-12">
            <div>
              ...
              <p className="mt-4 text-base text-gray-600 max-w-xs -tracking-tighter text-center">
                Our rice is not only delicious but also nutritious. It is a
                great source of carbohydrates, vitamins, and minerals.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-4 text-base text-gray-600 max-w-xs -tracking-tighter text-left">
