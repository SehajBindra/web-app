...
const keyfeatures = [
  {
    id: 1,
    name: "Trust",
    desc: `We have built a reputation for being a trusted and reliable rice supplier. Our customers can rely on us to provide them with quality products and excellent service every time they shop with us.
