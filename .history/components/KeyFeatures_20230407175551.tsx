...
function KeyFeatures() {
  return (
    <div className="py-40 bg-white ">
      <h2 className="text-4xl text-black md:text-4xl lg:text-5xl   capitalize mb-8 text-center ">
        why we Stand Out ?
      </h2>
      <div className="md:grid md:grid-cols-3 gap-0  overflow-hidden ">
        {keyfeatures.map((keyfeature) => (
          <div key={keyfeature.id}>
            <div className="max-w-xs flex flex-col font-semibold  md:flex-row    mx-auto  my-8 overflow-hidden md:max-w-sm rounded-md cursor-pointer">
