...
const products = [
  {
    ...
    name: `Tukda Rice`,
    price: ` 50`,
    desc: `Tukda rice is known for its small, round grains and its ability to absorb flavo well. It has a soft and sticky texture when cooked, making it ideal for dishes that require a slightly sticky rice.`,
    src: "/1.jpeg",
  },
  {
    id: 2,
    ...
    <div className="py-20">
      ...
      <div className="md:grid md:grid-cols-3 gap-4   overflow-hidden">
        {products?.map((product) => (
          <div key={product.id}>
            <div className="relative cuor-pointer block group">
              <img
                src={product.src}
                alt=""
