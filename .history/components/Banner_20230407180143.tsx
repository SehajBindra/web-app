  ...
  return (
    <div>
      <section>
              ...
              <div className="flex items-center flex-shrink-0">
                <a href="#" title="" className="inline-flex">
                  ...
                  <img
                    ...
                    src="https://t3.ftcdn.net/jpg/03/01/07/88/360_F_301078890_Fe1yAqmRfoLE9a9nCoQYDLZCYNsNiyIn.jpg"
                    alt=""
                  />
                  <p className="text-xl capitalize text-white">enterprises</p>
                </a>
              </div>

              <div className="hidden capitalize lg:flex lg:justify-center lg:space-x-10 xl:space-x-14">
                <a
                  href="#products"
                  title=""
                  className="text-base font-medium text-white/90 transition-all duration-200 rounded focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white hover:text-white"
                >
                  {" "}
                  Products{" "}
                </a>
        ...
        <div className="relative py-12 bg-black/80 sm:py-16 lg:py-20 xl:pt-32 xl:pb-44">
          <div className="absolute inset-0 hidden lg:block">
            <img
              className="object-cover opacity-80 object-center w-full h-full"
          ...
          <div className="relative px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
            <div className="max-w-xl mx-auto text-center lg:max-w-lg xl:max-w-2xl lg:text-left lg:mx-0">
              <h1 className="text-3xl  font-extrabold text-white sm:text-4xl xl:text-5xl xl:leading-tight">
                The Best Rice Sustainably Grown and Harvested
              </h1>
